...
const Header = () => {
  return  <header className="container mx-auto my-24">
  <div className="flex flex-col lg:flex-row justify-between items-center">
    <div>
      ...
      <button className="btn btn-primary bg-gradient-to-r from-[#FF8938] to-[#F00] border-none text-white">Explore More 
      <i className="fa-solid fa-square-arrow-up-right fa-beat-fade"></i>
      </button>

    </div>

    <div>
      <img src="images/banner.png" className="w-auto rounded-lg" />
